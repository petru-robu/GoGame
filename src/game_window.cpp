...
backgroundSprite(*ResourceManager::getInstance().getTexture("img/back.jpg"))
{
    ...
    to_play = new Label(window, "BLACK to play", 30.f,  Colors::TITLE_COLOR, "./fonts/shuriken.ttf", {1700, 140});
    game_type_label = new Label(window, "AI mode! Not ready! \nCome back later!", 30.f, Colors::TITLE_COLOR, "./fonts/shuriken.ttf", {1700, 70});
